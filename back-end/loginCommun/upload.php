...
if ($_FILES['file']) {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
        ...
        $sql = "INSERT INTO fichiers (nom, chemin, uploaders, taille,statut,type,listeDownload) VALUES ('$fileName','$filePath','$uploader','$size','$statut','$type','$listDownload')";
